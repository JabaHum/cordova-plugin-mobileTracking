...
exports.getCurrentPosition = function(success, fail, args) {
  console.log("getCurrentPosition");

    var param = {
        provider: MobileTracking.PROVIDER.GPS,
        accuracy: MobileTracking.ACCURACY.MEDIUM,
        power: MobileTracking.POWER.MEDIUM,
        minTime: 0,
    };
    console.log(param);
...
exports.watchPosition = function(success, fail, args) {

    exec(success, fail, "MobileTracking", "watchPosition", [param]);

};

exports.clearWatch = function(success, fail, args) {
